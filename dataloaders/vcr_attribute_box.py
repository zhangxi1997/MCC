...
class VCR(Dataset):
    ...
    def __getitem__(self, index):
        ...
        boxes = np.array(metadata['boxes'])[dets2use, :-1] # [left_x, left_y, right_x, right_y]
        ...
        if self.add_image_as_a_box:
            ...
            boxes = np.row_stack(([1, 1, w, h], boxes)) # N C W H
        ...
        instance_dict['det_features'] = ArrayField(tag_features[dets2use], padding_value=0)
